...
hl.env("GTK_IM_MODULE=simple", "simple")
...
hl.bind(mainMod .. " + W",
  hy3 ~= nil and hy3.make_group("tab", { toggle = true }) or raw_dispatch("hy3:makegroup tab toggle"))
hl.bind(mainMod .. " + E",
  hy3 ~= nil and hy3.make_group("v", { toggle = true }) or raw_dispatch("hy3:makegroup v toggle"))
...
hl.bind(mainMod .. " + SHIFT + H",
  hy3 ~= nil and hy3.move_window("l", { once = true }) or raw_dispatch("hy3:movewindow l once"))
hl.bind(mainMod .. " + SHIFT + L",
  hy3 ~= nil and hy3.move_window("r", { once = true }) or raw_dispatch("hy3:movewindow r once"))
hl.bind(mainMod .. " + SHIFT + K",
  hy3 ~= nil and hy3.move_window("u", { once = true }) or raw_dispatch("hy3:movewindow u once"))
hl.bind(mainMod .. " + SHIFT + J",
  hy3 ~= nil and hy3.move_window("d", { once = true }) or raw_dispatch("hy3:movewindow d once"))

for i = 1, 10 do
  local key = tostring(i % 10)
  hl.bind(mainMod .. " + " .. key, hl.dsp.focus({ workspace = i }))
  hl.bind(mainMod .. " + SHIFT + " .. key,
    hy3 ~= nil and hy3.move_to_workspace(tostring(i)) or raw_dispatch("hy3:movetoworkspace " .. i))
end
...
hl.bind("Print",
  hl.dsp.exec_cmd(
  [[bash -c 'grim -g "$(slurp)" -t png /tmp/screenshot-$(date +%F_%T).png; wl-copy < /tmp/screenshot-$(date +%F_%T).png']]))
hl.bind("SHIFT + Print",
  hl.dsp.exec_cmd([[bash -c 'grim /tmp/screenshot-$(date +%F_%T).png; wl-copy < /tmp/screenshot-$(date +%F_%T).png']]))
